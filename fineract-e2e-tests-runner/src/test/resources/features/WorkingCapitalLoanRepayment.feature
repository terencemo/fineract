...
Feature: Working Capital Loan Repayment
  ...
  Scenario: Verify working capital loan repayment - UC1: simple repayment
    ...
    Then Working Capital loan amortization schedule has 4 periods, with the following data for periods:
      ...
      | 0         | 01 January 2026 | -9000.00              |                     | 1                     | -9000.00 | 9000.00 |                            |                          |                    | 0.00            |
      | 1         | 02 January 2026 | 5000.00               | 270.00              | 1                     | 270.00   | 4658.91 | 0.00                       | 35.58                    | 35.58              | 0.00            |
      | 2         | 03 January 2026 | 5000.00               |                     | 0.9317821063276353179 | 4658.91  | 0.00    | 0.00                       |                          |                    | 0.00            |
      | 3         | 04 January 2026 |                       |                     | 0.8682178936723646887 | 4106.67  |         |                            |                          |                    | 0.00            |
...
#   --- Full expectedAmount paid in 2 payments on the same day---
    ...
    Then Working Capital loan amortization schedule has 5 periods, with the following data for periods:
      | paymentNo | paymentDate     | expectedPaymentAmount | actualPaymentAmount | discountFactor | npvValue | balance | expectedAmortizationAmount | actualAmortizationAmount | incomeModification | deferredBalance |
      | 0         | 01 January 2026 | -9000.00              |                     | 1              | -9000.00 | 9000.00 |                            |                          |                    | 0.00            |
      | 1         | 02 January 2026 | 5000.00               | 170.00              | 1              | 170.00   | 4658.91 | 0.00                       | 22.40                    | 22.40              | 0.00            |
      | 2         | 03 January 2026 | 5000.00               | 100.00              | 1              | 100.00   | 0.00    | 0.00                       | 13.18                    | 13.18              | 0.00            |
      | 3         | 04 January 2026 |                       |                     | 0.9317821063   | 4658.91  |         |                            |                          |                    | 0.00            |
      | 4         | 05 January 2026 |                       |                     | 0.8682178937   | 4106.67  |         |                            |                          |                    | 0.00            |
...
#   --- Partial expectedAmount paid ---
    ...
    Then Working Capital loan amortization schedule has 4 periods, with the following data for periods:
      ...
      | 1         | 02 January 2026 | 5000.00               | 170.00              | 1                     | 170.00   | 4658.91 | 0.00                       | 22.40                    | 22.40              | 0.00            |
      | 2         | 03 January 2026 | 5000.00               |                     | 0.9317821063276353179 | 4658.91  | 0.00    | 0.00                       |                          |                    | 0.00            |
      | 3         | 04 January 2026 |                       |                     | 0.8682178937          | 4193.49  |         |                            |                          |                    | 0.00            |
...
#   --- Start of 2nd period ---
  ...
  Scenario: Verify working capital loan repayment - UC14: expectedAmount overpaid in 1st period
    ...
    Then Working Capital loan amortization schedule has 4 periods, with the following data for periods:
      | paymentNo | paymentDate     | expectedPaymentAmount | actualPaymentAmount | discountFactor        | npvValue | balance | expectedAmortizationAmount | actualAmortizationAmount | incomeModification | deferredBalance |
      | 0         | 01 January 2026 | -9000.00              |                     | 1                     | -9000.00 | 9000.00 |                            |                          |                    | 0.00            |
      | 1         | 02 January 2026 | 5000.00               | 370.00              | 1                     | 370.00   | 4658.91 | 0.00                       | 48.76                    | 48.76              | 0.00            |
      | 2         | 03 January 2026 | 5000.00               |                     | 0.9317821063276353179 | 4658.91  | 0.00    | 0.00                       |                          |                    | 0.00            |
      | 3         | 04 January 2026 |                       |                     | 0.8682178937          | 4019.85  |         |                            |                          |                    | 0.00            |
...
#   --- Late period ---
    ...
    Then Working Capital loan amortization schedule has 4 periods, with the following data for periods:
      | paymentNo | paymentDate     | expectedPaymentAmount | actualPaymentAmount | discountFactor        | npvValue | balance | expectedAmortizationAmount | actualAmortizationAmount | incomeModification | deferredBalance |
      | 0         | 01 January 2026 | -9000.00              |                     | 1                     | -9000.00 | 9000.00 |                            |                          |                    | 0.00            |
      | 1         | 02 January 2026 | 5000.00               | 1500.00             | 1                     | 1500.00  | 4658.91 | 0.00                       | 197.67                   | 197.67             | 0.00            |
      | 2         | 03 January 2026 | 5000.00               |                     | 0.9317821063276353179 | 4658.91  | 0.00    | 0.00                       |                          |                    | 0.00            |
      | 3         | 04 January 2026 |                       |                     | 0.8682178937          | 3038.76  |         |                            |                          |                    | 0.00            |
